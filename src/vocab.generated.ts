...
export const VOCAB_METHODS: readonly string[] = ["absolute","alignItems","alignSelf","anchorName","animate","antialiased","aspect","backdropBlur","backdropBrightness","backdropContrast","backdropGrayscale","backdropHueRotate","backdropInvert","backdropSaturate","backdropSepia","background","block","blur","bold","border","borderColor","borderStyle","bottom","breakAll","brightness","capitalize","colSpan","containerQuery","contents","contrast","cursor","divideX","divideY","duration","ease","fixed","flex","flexDirection","flexShorthand","flexWrap","fontFamily","fontWeight","from","gap","gradient","gradientConic","gradientRadial","gradientTo","grayscale","grid","gridAutoCols","gridAutoFlow","gridAutoRows","gridCols","gridRows","group","grow","h","hidden","htmxIndicator","hueRotate","inline","inlineBlock","inlineFlex","inlineGrid","inset","invert","italic","justifyContent","leading","left","lineClamp","lineThrough","listStylePosition","listStyleType","lowercase","margin","maxH","maxW","minH","minW","neg","noUnderline","objectFit","opacity","order","outline","outlineHidden","overflow","overscroll","padding","peer","placeContent","placeItems","placeSelf","pointerEvents","positionAnchor","positionArea","relative","resize","right","ring","ringColor","rotate","rounded","saturate","scale","select","sepia","shadow","shadowColor","shrink","skewX","skewY","spaceX","spaceY","srOnly","static","sticky","tabularNums","textAlign","textColor","textSize","to","top","tracking","transition","translate","truncate","underline","underlineOffset","uppercase","via","viewTransitionName","w","whitespace","willChange","zIndex"];

/** Methods supporting the `(unit, amount)` arbitrary-value overload. */
export const UNIT_METHODS: ReadonlySet<string> = new Set(["bottom","gap","h","inset","leading","left","margin","maxH","maxW","minH","minW","padding","right","textSize","top","tracking","underlineOffset","w"]);
